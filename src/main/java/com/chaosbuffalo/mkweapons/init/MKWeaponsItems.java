...
public class MKWeaponsItems {
    ...
    public static void registerItems(RegistryEvent.Register<Item> evt) {
        ...
        MKCurioAccessory copperRing = new MKCurioAccessory(new Item.Properties().maxStackSize(1).group(ItemGroup.COMBAT));
        copperRing.setRegistryName(MKWeapons.MODID, "copper_ring");
        evt.getRegistry().register(copperRing);
        MKCurioAccessory goldRing = new MKCurioAccessory(new Item.Properties().maxStackSize(1).group(ItemGroup.COMBAT));
        goldRing.setRegistryName(MKWeapons.MODID, "gold_ring");
        evt.getRegistry().register(goldRing);
        MKCurioAccessory silverRing = new MKCurioAccessory(new Item.Properties().maxStackSize(1).group(ItemGroup.COMBAT));
        silverRing.setRegistryName(MKWeapons.MODID, "silver_ring");
        evt.getRegistry().register(silverRing);
        MKCurioAccessory roseGoldRing = new MKCurioAccessory(new Item.Properties().maxStackSize(1).group(ItemGroup.COMBAT));
        roseGoldRing.setRegistryName(MKWeapons.MODID, "rose_gold_ring");
        evt.getRegistry().register(roseGoldRing);
        MKCurioAccessory silverEarring = new MKCurioAccessory(new Item.Properties().maxStackSize(1).group(ItemGroup.COMBAT));
        silverEarring.setRegistryName(MKWeapons.MODID, "silver_earring");
        evt.getRegistry().register(silverEarring);
        MKCurioAccessory goldEarring = new MKCurioAccessory(new Item.Properties().maxStackSize(1).group(ItemGroup.COMBAT));
